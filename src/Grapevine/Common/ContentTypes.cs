...
namespace Grapevine.Common
{
    public static class ContentTypes
    {
        ...
        /// <summary>
        /// Returns a Content Type value for the filename or extension provided
        /// </summary>
    ...
    internal class ContentTypeMetadata : Attribute
    {
        ...
        /// <summary>
        /// A value that indicates whether this mime type represents plain text
        /// </summary>
        public bool IsText { get; set; }

        /// <summary>
        /// A value that indicates whether this mime type represents binary data
        /// </summary>
    ...
    public enum ContentType
    {
        ...
        [ContentTypeMetadata(Value = "application/x-javascript", IsText = true)]
        JS,
        ...
        [ContentTypeMetadata(Value = "chemical/x-pdb", IsBinary = true)]
        PDB,
        ...
        [ContentTypeMetadata(Value = "text/rtf", IsText = true)]
        RTF,
        ...
        [ContentTypeMetadata(Value = "application/smil", IsBinary = true)]
        SMI,
